/** 
 * Fichier: WithLabelFieldElement.java
 * 
 ...
 */
public class WithLabelFieldElement extends FieldElement
{
	/**
	 * Constructor
	 ...
	 */
	public WithLabelFieldElement(String name, String path)
	{
		super(name, path);
	}
	...
	{
		String[] addresses = getValues(request, name);
		...
		for (int i=0; i<addresses.length; i++)
		{
			if ("".equals(addresses[i]))
				continue;
			FieldValue value = createFieldValue(addresses[i]);
