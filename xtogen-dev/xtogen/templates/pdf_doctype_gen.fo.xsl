...
<xsl:stylesheet version="1.0"
		...
		<fo:root>
			...
			<fo:page-sequence master-reference="sequence">
				...
				<fo:flow flow-name="xsl-region-body">
					<!-- 1ere page -->
					<fo:block id="xtg-fop-booklet-multiple" font-size="18pt" font-family="sans-serif" color="white" background-color="gray">
					...
					<fo:block id="xtg-fop-booklet-page">
						...
						<fo:block id="xtg-field-id-{$df}" font-size="18pt" font-family="sans-serif" line-height="24pt" space-after.optimum="15pt" background-color="gray" color="white" text-align="center"><fo:block id="xtg-field-value">#<xsl:value-of select="$df"/>#</fo:block></fo:block>
						<fo:table>
					...
					<fo:block id="xtg-fop-generated-by" font-size="8pt">#document generated by XToGen#</fo:block>
	...
	<xsl:template name="manage-reverse">
		...
		<fo:table-row id="xtg-reversefield-{$doc}/{$field}">
			<fo:table-cell padding="4pt" border="0.1pt solid black" background-color="gray">
				<fo:block id="xtg-field-name-{@name}" color="white">#reverse#<xsl:value-of select="$doc"/>#<xsl:value-of select="$field"/>#</fo:block>
			</fo:table-cell>
			<fo:table-cell padding="4pt" border="0.1pt solid black">
	...
	<xsl:template match="field">
		<fo:table-row id="xtg-field-id-{@name}">
			<fo:table-cell padding="4pt" border="0.1pt solid black" background-color="gray">
				<fo:block id="xtg-field-name-{@name}" color="white">#<xsl:value-of select="@name"/>#</fo:block>
			</fo:table-cell>
			<fo:table-cell padding="4pt" border="0.1pt solid black">
				<fo:block id="xtg-field-value-{@name}">#value#</fo:block>
			</fo:table-cell>
	...
	<xsl:template match="fieldgroup">
		<fo:table-row id="xtg-fieldgroup-id-{@name}">
			<fo:table-cell padding="4pt" border="0.1pt solid black" background-color="silver" number-columns-spanned="2">
