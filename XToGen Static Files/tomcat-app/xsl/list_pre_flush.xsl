...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:sdx="http://www.culture.gouv.fr/ns/sdx/sdx" exclude-result-prefixes="sdx">
	...
	<xsl:template match="question">
		...
		<div align="center">
		<xsl:value-of select="$messages[@id='page.pre_flush.voulezvousvraimentviderlaliste']"/>&#160;<b><xsl:value-of select="$list"/></b> ?<br/>
		<a class="nav" href="list_flush.xsp?list={$list}"><xsl:value-of select="$messages[@id='common.oui']"/></a>&#160;
